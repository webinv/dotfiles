...
for dotfile in .bash_aliases .bash_profile .bashrc .bashrc_local .gitconfig .gitignore_global .profile .screenrc .vimrc .zshrc .oh-my-posh/personal_minimal.omp.json .oh-my-posh/personal.omp.json .ssh/config .ssh/authorized_keys
do
